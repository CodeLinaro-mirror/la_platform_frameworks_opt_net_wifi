...
public class ActiveModeWarden {
    ...
    public void enableStation(int staId) {
        mHandler.post(() -> {
            ...
            if (getQtiClientModeManager() == null) {
    ...
    public void disableStation(int staId) {
        mHandler.post(() -> {
            ...
            if (staId == 0 /* disable all */) {
                ...
                QtiClientModeManager manager = getQtiClientModeManager();
                if (manager != null) {
                    manager.stop();
                    mActiveModeManagers.remove(manager);
                } else {
    ...
    public QtiClientModeImpl getQtiClientModeImpl() {
        QtiClientModeManager manager = getQtiClientModeManager();
        if (manager != null) {
    ...
    public AsyncChannel getQtiClientImplChannel() {
        QtiClientModeManager manager = getQtiClientModeManager();
        if (manager != null) {
